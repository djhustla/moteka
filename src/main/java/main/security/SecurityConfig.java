        ...
        http
                ...
                .authorizeHttpRequests(authz -> authz
                        ...
                        .requestMatchers(
                                ...
                                "/api/users/register-admin","/api/users/resend-validation-code",

                                 "/api/users/*/activate","/api/users/*/photo-url",
                                "/api/users/*/role",
                                "/api/users/artistes",
                                "/api/musicbrainz/**",
                                "/api/users/*/listeReseaux"
                        ...
                        .requestMatchers(
                                ...
                                "/api/playlists/**",
                                "/api/users/**",
                                "/api/spotify/searchAll","/api/spotify/track/artists"
                                ,"/api/users/update-visible-donnee-visible-artistes",
                                "/api/spotify/recherche-par-type",
                                "/api/users/auto-tag-artist-preferences",
                                "/api/music-favoris/**",
                                "/api/spotify/track/summary",
                                "/api/music/**"

                                //.requestMatchers("/api/users/encodage-auto-genres-artistes").permitAll()
                        ).permitAll()
