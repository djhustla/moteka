...
public class UserController {
    ...
    // ... (les autres méthodes restent inchangées, ajoutez juste les getters pour phoneNumber et isActive) ...
    ...
    public ResponseEntity<Map<String, Object>> updateCurrentUser(
        ...
        try {
            ...
            // Gestion de la photo (même logique que précédemment)
            // ...
            ...
            response.put("user", Map.of(
                    ...
                    "donneeVisible", updatedUser.getDonneeVisible(),
